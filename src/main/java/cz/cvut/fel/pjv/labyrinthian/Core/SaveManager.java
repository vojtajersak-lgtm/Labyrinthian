    ...
    public void loadGame(GameManager gm) {
        ...
        try (FileReader reader = new FileReader(SAVE_FILE_PATH)) {
            ...
            switch (data.playerActiveWeapon){
                ...
                default -> throw new IllegalStateException("Unexpected value: " + data.playerActiveWeapon);
            }
            ...
            if (data.savedClayPots != null) {
                for (SaveData.ClayPotData potData : data.savedClayPots) {
                    ...
                    gm.getClayPots().add(new ClayPot(potData.y, potData.x, 64, 64, randomItem));
                }
            }
